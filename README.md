...
CACv Supermarket (Kyanja, Kampala) needs help preparing procurement decisions. This project builds an AI-native agent that:
...
**Data used:** synthetic/team-created inventory and supplier quotation CSV/JSON files (no real CACv Supermarket financial or supplier data).
